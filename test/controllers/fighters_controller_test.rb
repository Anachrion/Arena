...
class FightersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fighter" do
    assert_difference('Fighter.count') do
      post fighters_url, params: { fighter: { description: @fighter.description, hit_points: @fighter.hit_points, name: @fighter.name, precision: @fighter.precision, strength: @fighter.strength } }
    end
  ...
  test "should update fighter" do
    patch fighter_url(@fighter), params: { fighter: { description: @fighter.description, hit_points: @fighter.hit_points, name: @fighter.name, precision: @fighter.precision, strength: @fighter.strength } }
