...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { damage_modifier: @weapon.damage_modifier, description: @weapon.description, name: @weapon.name, precision_modifier: @weapon.precision_modifier } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { damage_modifier: @weapon.damage_modifier, description: @weapon.description, name: @weapon.name, precision_modifier: @weapon.precision_modifier } }
