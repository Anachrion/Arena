...
class FightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fight" do
    assert_difference('Fight.count') do
      post fights_url, params: { fight: { description: @fight.description, name: @fight.name } }
    end
  ...
  test "should update fight" do
    patch fight_url(@fight), params: { fight: { description: @fight.description, name: @fight.name } }
